...
my %frameReadings = (
 ...
 'DI-Buffer'              => { addr => 0x00D0, bytes => 0x0001,                  unp => 'B8' },
 'DO-Buffer'              => { addr => 0x00CF, bytes => 0x0001,                  unp => 'B8' },
 'Ausfall_Zeit'           => { addr => 0x0091, bytes => 0x0003, fmat => '%3$02d:%2$02d:%1$02d', unp => 'CCC' },
 'Ausfall_Datum'          => { addr => 0x0094, bytes => 0x0003, fmat => '%02d.%02d.%02d', unp => 'CCC'},
 'Ausfall_BetriebMode'    => { addr => 0x0097, bytes => 0x0001,                  unp => 'B8' },
 'Ausfall_DO-Buffer'      => { addr => 0x0098, bytes => 0x0001,                  unp => 'B8' },
 'Ausfall_DI-Buffer'      => { addr => 0x0099, bytes => 0x0001,                  unp => 'B8' },
 'Ausfall_FuehlAusfall'   => { addr => 0x009A, bytes => 0x0001,                  unp => 'B8' },
 'Ausfall_FuehlKurzsch'   => { addr => 0x009B, bytes => 0x0001,                  unp => 'B8' },
 'Ausfall_TempAussen'     => { addr => 0x009C, bytes => 0x0004,                  unp => 'f<' },
 'Ausfall_TempWQEin'      => { addr => 0x00A0, bytes => 0x0004,                  unp => 'f<' },
 'Ausfall_TempWQAus'      => { addr => 0x00A4, bytes => 0x0004,                  unp => 'f<' },
 'Ausfall_TempVerdampfer' => { addr => 0x00A8, bytes => 0x0004,                  unp => 'f<' },
 'Ausfall_TempRueckl'     => { addr => 0x00AC, bytes => 0x0004,                  unp => 'f<' },
 'Ausfall_TempVorlauf'    => { addr => 0x00B0, bytes => 0x0004,                  unp => 'f<' },
 'Ausfall_TempKondens'    => { addr => 0x00B4, bytes => 0x0004,                  unp => 'f<' },
 'Ausfall_TempWarmwasser' => { addr => 0x00B8, bytes => 0x0004,                  unp => 'f<' },
 'Ausfall_RaumAusfall'    => { addr => 0x00BC, bytes => 0x0001,                  unp => 'B8' },
 'Ausfall_RaumKurzsch'    => { addr => 0x00BD, bytes => 0x0001,                  unp => 'B8' },
 'Ausfall_TempRaum'       => { addr => 0x00BE, bytes => 0x0004,                  unp => 'f<' },
 'Ausfall_Reset'          => { addr => 0x00C2, bytes => 0x0001 								 },
 'Unterbrechungen'        => { addr => 0x00C3, bytes => 0x0001,                  unp => 'B8' },
 'Warnung_Eingangsseite'  => { addr => 0x00C4, bytes => 0x0001,                  unp => 'B8' },
 'Warnung_Ausgangsseite'  => { addr => 0x00C5, bytes => 0x0001,                  unp => 'B8' },
 'Warnung_Sonstige'       => { addr => 0x00C6, bytes => 0x0001,                  unp => 'B8' },
